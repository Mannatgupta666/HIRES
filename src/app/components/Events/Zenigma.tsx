        ...
        <div className="relative flex flex-col bg-orange-500 w-full md:h-[400px] sm:h-[300px] h-[400px] rounded-xl ">
            ...
            <div className="absolute flex w-full h-full">
                <div className="absolute flex flex-col left-[10vw] lg:top-[10vh] md:top-[10vh] top-[15vh] w-[40vw] sm:gap-y-8 gap-y-4">
                    <h1 className="font-bold lg:text-7xl md:text-6xl text-3xl">Zenigma</h1>
            ...
            <div className="relative w-full h-full" style={{opacity:1}}>
                <img src="/assets/zenigmaBG.webp" alt="phone"  className="transition-transform duration-300 ease-in-out hover:scale-105"/>
            </div>
            </div>
